        ...
        <div className='flex gap-6 justify-center'>
            <div className='w-[40%]'>
                ...
                <div>
                    ...
                    {/* ### DESCRIPTION START ### */}
                    <div className='bg-white mt-6 p-4 border border-gray-300 drop-shadow-sm'>
                        <h6 className='text-[20px] text-[#373373]'>Description</h6>        
                        <p className='mt-4 '>One bedroom in a 5 bedroom house in Clayton Park close to all amenities, bus route . Everything included including a shared kitchen living room and dining room . Each bedroom will have their own individual mini fridge and microwave .Cable and internet
                        </p>
