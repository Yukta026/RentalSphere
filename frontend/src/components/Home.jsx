...
const Home = () => {
    ...
    return (
        <div>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex items-center space-x-8'>
                            ...
                            <div className='flex items-center space-x-4'>
                                <button className='px-4 py-2 bg-gray-800 capitalize hover:bg-gray-600 text-white rounded-full font-semibold' onClick={() => {
                                    navigate(`/property-manager`);
                                }}>property manager</button>

                                <button className='px-4 py-2 bg-gray-800 capitalize hover:bg-gray-600 text-white rounded-full font-semibold' onClick={() => {
                                    navigate(`/tenet-dashboard`);
                                }}>Tenet Login</button>
                            </div>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full m-6">
                <div className="relative mx-auto w-full">
                    <NavLink to="#" className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                        <div className="shadow p-4 rounded-lg bg-white">
                            <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                                <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                                    ...
                                    <img src="https://cdn.pixabay.com/photo/2017/09/09/18/25/living-room-2732939_1280.jpg" alt="" className='' />
                                </div>
