            ...
            <div className="shadow p-4 rounded-lg bg-white">
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                ...
                <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  ...
                  <span className="mt-2 xl:mt-0">1,386 sq. ft.</span>
                </p>
                <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  <svg
                    className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                  ...
                  <span className="mt-2 xl:mt-0">$1.98 /sq.ft</span>
                </p>
              </div>
            ...
            <div className="shadow p-4 rounded-lg bg-white">
              <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                  ...
                  <img
                    src="https://t3.ftcdn.net/jpg/03/52/37/10/360_F_352371034_A3oZKEiUmSv22llbnCiKORQ4RLxNqJvr.jpg"
                    alt=""
                    className=""
                  />
                </div>
            ...
            <div className="shadow p-4 rounded-lg bg-white">
              <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                  ...
                  <img
                    src="https://t3.ftcdn.net/jpg/04/31/36/62/360_F_431366205_3IpGkHKjIoyMDMPLNG7WAOhAaSLkZ8BS.jpg"
                    alt=""
                    className=""
                  />
                </div>
            ...
            <div className="shadow p-4 rounded-lg bg-white">
              <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                  ...
                  <img
                    src="https://as2.ftcdn.net/v2/jpg/04/82/39/91/1000_F_482399159_oCvn3xuvjD7m6kdOsxB2CGJXkgAdaMID.jpg"
                    alt=""
                    className=""
                  />
                </div>
